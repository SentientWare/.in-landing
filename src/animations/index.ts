...
const animateHeroNav = () => {
  ...
  gsap.fromTo('.status-dot',
    { scale: 0, opacity: 0 },
    { scale: 1, opacity: 1, delay: 0.3, duration: 0.8, ease: 'elastic.out(1, 0.5)' }
  );

  // Code card animation
  gsap.fromTo('#profile-container',
    { y: 30, opacity: 0, scale: 0.95 },
    { y: 0, opacity: 1, scale: 1, delay: 0.4, duration: 1.2, ease: 'power4.inOut' }
  );

  // Contact button animation
  gsap.fromTo('#contact-btn',
    { y: 30, opacity: 0 },
    { y: 0, opacity: 1, delay: 0.6, duration: 1, ease: 'power4.inOut' }
  );

  // Available for work animation
  gsap.fromTo('#available-for-work',
    { y: 30, opacity: 0 },
    { y: 0, opacity: 1, delay: 0.7, duration: 1, ease: 'power4.inOut' }
  );
