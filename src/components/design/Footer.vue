    ...
    <div class="grid w-full grid-cols-12">
      <div class="col-span-7 place-content-center md:col-span-6">
        <h6 class="heading-4 sm:heading-2 leading-none font-bold">
          © {{ new Date().getFullYear() }} SentientWare <br />
          Tech Solution Pvt Ltd. <br />
          All rights reserved.
        </h6>
      </div>
      ...
      >
        <p class="heading-6 font-bold uppercase">Our Office</p>
        <p class="heading-6">Berhampur, Odisha, India</p>

        <p class="heading-6 font-bold uppercase mt-2">Working Hours</p>
        <p class="heading-6">Mon – Fri: 9:00 AM – 6:00 PM</p>
        <p class="heading-6">Sat – Sun: Closed</p>

        <p class="heading-6 font-bold uppercase mt-2">Your Local Time</p>
