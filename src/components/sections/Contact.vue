  ...
  >
    ...
    >
      ...
      <div class="flex-center z-10 flex-col gap-y-10">
        ...
        >
          Your idea is a masterpiece waiting to become alive.
        </p>
        <h3
          id="make-it-happen"
        ...
        >
          <Button label="Get in touch" url="mailto:info@sentientware.in" />
        </div>
      </div>
      ...
      >
        ...
        <div class="heading-6 text-flax-smoke-500 w-fit">
          ...
          />
          <Link
            class="text-flax-smoke-300 h-6 text-right font-medium tracking-wider"
            label="+91 6371763610"
            :icon="true"
            url="tel:+916371763610"
          />
        </div>
      </div>
    </div>
