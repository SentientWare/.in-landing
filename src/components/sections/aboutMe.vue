  ...
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          With a passion for design and development, We take projects from
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            SentientWare Tech Solution Pvt Ltd is a leading technology company specializing in custom software development, web and mobile applications, AI solutions, cloud infrastructure, and cybersecurity. <br /><br />
            When I'm not immersed in web development and design, you can find me
            Our mission is to empower businesses with innovative technology solutions<i>&Xopf;</i>,
